...
static struct wcd_mbhc_register
	...
	WCD_MBHC_REGISTER("WCD_MBHC_IN2P_CLAMP_STATE", /* NOT SUPPORTED? */
...
static const struct tasha_reg_mask_val tasha_spkr_default[] = {
	...
	{WCD9335_CDC_BOOST0_BOOST_CTL, 0x7C, 0x64},
	{WCD9335_CDC_BOOST1_BOOST_CTL, 0x7C, 0x64},
};
...
static const struct tasha_reg_mask_val tasha_spkr_mode1[] = {
	...
	{WCD9335_CDC_BOOST0_BOOST_CTL, 0x7C, 0x55},
	{WCD9335_CDC_BOOST1_BOOST_CTL, 0x7C, 0x55},
};
				      ...
				      int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		if (tasha->anc_func) {
			/* Remove ANC Rx from reset */
			snd_soc_update_bits(codec,
				WCD9335_CDC_ANC1_CLK_RESET_CTL, 0x08, 0x00);
		}
#endif
		break;
